...
var base = Rebase.createClass({
  apiKey: "AIzaSyC_0r87Mz8WzNXdnjxzc94ZQVfcWHL_eZ8",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-final-25422.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var SortBar = React.createClass({
  viewChanged: function(view) {
    ...
    this.setState({activeViewClassName: view})
  },
  getInitialState: function() {
    return {activeViewClassName: this.props.activeViewClassName }
  },
  render: function() {
    return (
      <div className="sort row">
        <div className="col-sm-12">
          <ul className="nav nav-pills">
            <li className={(this.state.activeViewClassName === "latest") ? "active" : ""}><a href="#" onClick={() => this.viewChanged('latest')}>Latest Releases</a></li>
            <li className={(this.state.activeViewClassName === "alpha") ? "active" : ""}><a href="#" onClick={() => this.viewChanged('alpha')}>A-Z</a></li>
            <li className={(this.state.activeViewClassName === "map") ? "active" : ""}><a href="#" onClick={() => this.viewChanged('map')}>Where to Watch</a></li>
      ...
      return (
        <div className="map col-sm-12">
          <Gmaps width={'100%'}
                 ...
                 lng={'-87.6285782'}
                 zoom={11}
                 loadingMessage={'Movie theater locations coming soon...'}
